...
int main(void) {
    ...
    while(1) {
        ...
        // Alternating pattern
        IO0SET = 0x00AA0000;  // LEDs at even positions ON
        IO0CLR = 0x00550000;  // LEDs at odd positions OFF
        delay_ms(500);

        IO0SET = 0x00550000;  // LEDs at odd positions ON
        IO0CLR = 0x00AA0000;  // LEDs at even positions OFF
        delay_ms(500);
    }
}
